...
INSERT INTO Artist (ArtistName, YearEstablished) VALUES ('Axius Link', 2012);
INSERT INTO Album (Title, ReleaseDate, AlbumLength, Label, ArtistId, GenreId) VALUES ('MELT', '4/15/2021', 128, 'The Orchard Music', 28, 14);
INSERT INTO Song (Title, SongLength, ReleaseDate, GenreId, ArtistId, AlbumId) VALUES ('MELT', 315, '4/15/2021', 14,  28, 23);
...
SELECT COUNT(a.Id) AS NumOfSongs, a.Title
FROM Album a 
JOIN Song s ON s.AlbumId = a.Id
GROUP BY a.Title;

SELECT COUNT(Song.ArtistId) AS NumOfSongs, Artist.ArtistName
FROM Song 
JOIN Artist ON Artist.Id = Song.ArtistId
GROUP BY Artist.ArtistName;

SELECT COUNT(Song.GenreId) AS NumOfSongs, Genre.Name
FROM Song
JOIN Genre ON Genre.Id = Song.GenreId
GROUP BY Genre.Name;
